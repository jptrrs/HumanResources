...
namespace HumanResources
{
    ...
    public class CompKnowledge : ThingComp
    {
        ...
        private int? AnomalyHomeworkIndex;
        ...
        public ResearchProjectDef CurrentAnomalyProj
        {
            get
            {
                if (!AnomalyHomeworkIndex.HasValue)
                {
                    ResearchProjectDef tech = homework.Find(x => x.knowledgeCategory != null);
                    if (tech != null) AnomalyHomeworkIndex = homework.IndexOf(tech);
                    return tech;
                }
                return homework[AnomalyHomeworkIndex.Value];
            }
        }
        ...
        public void AssignBranch(ResearchProjectDef tech)
        {
            ...
            if (TechTracker.Anomaly && tech.knowledgeCategory != null) AssignAnomaly(tech);
            else
            {
                homework.Add(tech);
        ...
        private void AssignAnomaly(ResearchProjectDef tech)
        {
            homework.RemoveAll(x => x.knowledgeCategory != null);
            homework.Add(tech);
            AnomalyHomeworkIndex = homework.IndexOf(tech);
        }

        public void CancelBranch(ResearchProjectDef tech)
        {
            if (TechTracker.Anomaly && tech.knowledgeCategory != null) CancelAnomaly(tech);
            else
            {
        ...
        private void CancelAnomaly(ResearchProjectDef tech)
        {
            homework.RemoveAll(x => x.knowledgeCategory != null);
            AnomalyHomeworkIndex = null;
        }
