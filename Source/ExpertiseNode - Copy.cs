...
{
    public class ExpertiseNode : ResearchNode
    {
        ...
        public ExpertiseNode(ResearchProjectDef research, Pawn pawn) : base(research)
        {
            Pawn = pawn;
        }
        ...
        private CompKnowledge techComp => Pawn.GetComp<CompKnowledge>();
        ...
        public new void DrawAt(Vector2 pos, Rect visibleRect, bool forceDetailedMode = false)
        {
            SetRects(pos);
